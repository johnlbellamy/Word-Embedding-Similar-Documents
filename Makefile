...
use:
	$(PYTHON_INTERPRETER) src/models/use_semantic_model.py

svd:
	$(PYTHON_INTERPRETER) src/models/svd_sematic_model.py

svd_sentiment:
	$(PYTHON_INTERPRETER) src/models/sentiment.py svd

use_sentiment:
	$(PYTHON_INTERPRETER) src/models/sentiment.py embed
